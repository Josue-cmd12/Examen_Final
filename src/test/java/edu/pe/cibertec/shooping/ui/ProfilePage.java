...
public class ProfilePage {
    public static final Target PROFILE_TAB = Target.the("pestaña perfil")
            .located(AppiumBy.xpath("//android.widget.TextView[contains(@text,'erfil')]"));
    ...
    public static final Target CONFIRM_LOGOUT_BUTTON = Target.the("botón confirmar cierre de sesión")
